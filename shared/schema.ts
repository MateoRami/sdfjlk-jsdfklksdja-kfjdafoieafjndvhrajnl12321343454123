...
export const moves = pgTable("moves", {
  ...
  previousValue: integer("previous_value"), // value that was in cell before this move
  previousNotes: jsonb("previous_notes"), // notes that were in cell before this move
